/**
 * Login.jsx
 * Public authentication screen allowing users to log in with email and password.
 */
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white border border-slate-200 rounded-lg shadow-md max-w-md w-full p-8">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-slate-500 mt-1">Sign in to your collaborative account</p>
        </div>
