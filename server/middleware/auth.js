 ...
 * Extracts the JWT bearer token from requests, decodes it, and appends the User instance to the request.
 */
...
const protect = async (req, res, next) => {
  ...
  // Check if token exists in Authorization header in format: Bearer <token>
  if (
